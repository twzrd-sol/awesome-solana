...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) - MCP server for AI agent trust scoring on Solana. Free preflight + paid signed trust receipt via x402 micropayment. Remote at `https://intel.twzrd.xyz/mcp` — no install required.
